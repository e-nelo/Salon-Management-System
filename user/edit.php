...
<?php //if edit values are submitted, call the validate function. If no errors are found, update the user values in the database. If errors are found, return an errormessage.
            if(isset($_POST["firstname"]))
                  {
                    ...
                    if($error==false)
                    {
                       ...
                       <?php edit($id, $firstname, $lastname, $email, $phone, $address, $gender, $password, $type); ?>
                    </table></div>
                        <?php
                    }
                    else{
...
?> <div class="col-lg-5" id="edit">
                <b><h3>Update Profile</b></h3>
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        <input type="text" name="type" class="form-control" placeholder="Enter Gender" value="<?php echo $row["type"];?>">
                    </div>
                    <div class="form-group">
